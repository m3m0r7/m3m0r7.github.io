...
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.Tsumo = void 0;\nconst Yaku_1 = __webpack_require__(/*! ../Yaku */ \"./src/Yaku/index.ts\");\nclass Tsumo {\n    constructor(paiPairCollection, yakuList, option) {\n        this.paiPairCollection = paiPairCollection;\n        this.option = option;\n        this.yakuList = yakuList;\n    }\n    get value() {\n        return this.option.hora.fromTsumo && !this.paiPairCollection.isChiiToitsu && !this.yakuList.some(yaku => yaku instanceof Yaku_1.Pinfu)\n            ? 2\n            : 0;\n    }\n    get isFulfilled() {\n        return this.value > 0;\n    }\n}\nexports.Tsumo = Tsumo;\n\n\n//# sourceURL=webpack:///./src/Fu/Tsumo.ts?");
...
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.Chanta = void 0;\nconst PaiGenerator_1 = __webpack_require__(/*! ../Utilities/PaiGenerator */ \"./src/Utilities/PaiGenerator.ts\");\nconst JunChanta_1 = __webpack_require__(/*! ./JunChanta */ \"./src/Yaku/JunChanta.ts\");\nclass Chanta {\n    constructor(paiPairCollection, option) {\n        this.paiPairCollection = paiPairCollection;\n        this.option = option;\n    }\n    get type() {\n        return 'NORMAL';\n    }\n    get han() {\n        return this.paiPairCollection.hasFuro\n            ? 1\n            : 2;\n    }\n    get parent() {\n        return new JunChanta_1.JunChanta(this.paiPairCollection, this.option);\n    }\n    get isFulfilled() {\n        return this.paiPairCollection.paiPairs\n            .every(paiPair => (paiPair.isJantou && paiPair.pattern.includesWithMatrix(PaiGenerator_1.PaiGenerator.generateYaoChuHai()))\n            || (paiPair.isShuntsu && PaiGenerator_1.PaiGenerator.generatePenchanHai().some(paiNames => paiPair.pattern.includesWithMatrix(paiNames, 'AND')))\n            || ((paiPair.isKoutsu || paiPair.isToitsu) && paiPair.pattern.includesWithMatrix(PaiGenerator_1.PaiGenerator.generateYaoChuHai())));\n    }\n}\nexports.Chanta = Chanta;\n\n\n//# sourceURL=webpack:///./src/Yaku/Chanta.ts?");
...
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.ChinRoutou = void 0;\nconst PaiGenerator_1 = __webpack_require__(/*! ../Utilities/PaiGenerator */ \"./src/Utilities/PaiGenerator.ts\");\nclass ChinRoutou {\n    constructor(paiPairCollection, option) {\n        this.paiPairCollection = paiPairCollection;\n        this.option = option;\n    }\n    get type() {\n        return 'FULL';\n    }\n    get isFulfilled() {\n        return this.paiPairCollection.paiPairs\n            .every(paiPair => (paiPair.isJantou || paiPair.isKoutsu || paiPair.isKan) && paiPair.pattern.includesWithMatrix(PaiGenerator_1.PaiGenerator.generateRoutouHai()));\n    }\n}\nexports.ChinRoutou = ChinRoutou;\n\n\n//# sourceURL=webpack:///./src/Yaku/ChinRoutou.ts?");
...
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.HonRoutou = void 0;\nconst PaiGenerator_1 = __webpack_require__(/*! ../Utilities/PaiGenerator */ \"./src/Utilities/PaiGenerator.ts\");\nclass HonRoutou {\n    constructor(paiPairCollection, option) {\n        this.paiPairCollection = paiPairCollection;\n        this.option = option;\n    }\n    get type() {\n        return 'NORMAL';\n    }\n    get han() {\n        return 2;\n    }\n    get isFulfilled() {\n        return this.paiPairCollection.paiPairs\n            .filter(v => !v.isJantou)\n            .every(paiPair => (paiPair.isKoutsu || paiPair.isKan || paiPair.isToitsu) && paiPair.pattern.includesWithMatrix(PaiGenerator_1.PaiGenerator.generateYaoChuHai()));\n    }\n}\nexports.HonRoutou = HonRoutou;\n\n\n//# sourceURL=webpack:///./src/Yaku/HonRoutou.ts?");
...
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.JunChanta = void 0;\nconst PaiGenerator_1 = __webpack_require__(/*! ../Utilities/PaiGenerator */ \"./src/Utilities/PaiGenerator.ts\");\nclass JunChanta {\n    constructor(paiPairCollection, _) {\n        this.paiPairCollection = paiPairCollection;\n    }\n    get type() {\n        return 'NORMAL';\n    }\n    get han() {\n        return this.paiPairCollection.hasFuro\n            ? 2\n            : 3;\n    }\n    get isFulfilled() {\n        return this.paiPairCollection.paiPairs\n            .every(paiPair => (paiPair.isJantou && paiPair.pattern.includesWithMatrix(PaiGenerator_1.PaiGenerator.generateRoutouHai()))\n            || (paiPair.isShuntsu && PaiGenerator_1.PaiGenerator.generatePenchanHai().some(paiNames => paiPair.pattern.includesWithMatrix(paiNames, 'AND')))\n            || ((paiPair.isKoutsu || paiPair.isToitsu) && paiPair.pattern.includesWithMatrix(PaiGenerator_1.PaiGenerator.generateRoutouHai())));\n    }\n}\nexports.JunChanta = JunChanta;\n\n\n//# sourceURL=webpack:///./src/Yaku/JunChanta.ts?");
...
/***/ "./src/Yaku/MenzenTsumo.ts":
/*!*********************************!*\
  !*** ./src/Yaku/MenzenTsumo.ts ***!
  \*********************************/
/***/ ((__unused_webpack_module, exports) => {

eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.MenzenTsumo = void 0;\nclass MenzenTsumo {\n    constructor(paiPairCollection, option) {\n        this.paiPairCollection = paiPairCollection;\n        this.option = option;\n    }\n    get type() {\n        return 'NORMAL';\n    }\n    get han() {\n        return 1;\n    }\n    get isFulfilled() {\n        return !this.paiPairCollection.hasFuro\n            && this.option.hora.fromTsumo;\n    }\n}\nexports.MenzenTsumo = MenzenTsumo;\n\n\n//# sourceURL=webpack:///./src/Yaku/MenzenTsumo.ts?");
