...
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.JunChanta = void 0;\nconst PaiGenerator_1 = __webpack_require__(/*! ../Utilities/PaiGenerator */ \"./src/Utilities/PaiGenerator.ts\");\nclass JunChanta {\n    constructor(paiPairCollection, _) {\n        this.paiPairCollection = paiPairCollection;\n    }\n    get type() {\n        return 'NORMAL';\n    }\n    get han() {\n        return this.paiPairCollection.hasFuro\n            ? 2\n            : 3;\n    }\n    get isFulfilled() {\n        return this.paiPairCollection.paiPairs\n            .every(paiPair => (paiPair.isJantou && paiPair.pattern.includesWithMatrix(PaiGenerator_1.PaiGenerator.generateYaoChuHai()))\n            || (paiPair.isShuntsu && PaiGenerator_1.PaiGenerator.generatePenchanHai().some(paiNames => paiPair.pattern.includesWithMatrix(paiNames, 'AND')))\n            || (paiPair.isKoutsu && paiPair.pattern.includesWithMatrix(PaiGenerator_1.PaiGenerator.generateRoutouHai())));\n    }\n}\nexports.JunChanta = JunChanta;\n\n\n//# sourceURL=webpack:///./src/Yaku/JunChanta.ts?");
