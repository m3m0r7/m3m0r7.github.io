...
import PaiSelectionContext, { PaiSelectionType } from "../../Context/PaiSelectionContext";
...
const DialogSelectPai = () => {
  ...
  return <div className="dialog">
    ...
    <div className="dialog-contents">
      <ul>
        <li className="mb-2"><label className="align-middle"><CheckBox
          ref={horaRef}/>
          <ruby>和了
            <rp>(</rp>
            <rt>あがり</rt>
        ...
        <li className="mb-2"><label className="align-middle"><CheckBox
          ref={furoRef}/>鳴いた牌ですか？（ポン/チー/カン）</label></li>

        {parseInt(number) === 5 &&
          <li className="mb-2"><label className="align-middle"><CheckBox ref={akaDoraRef}/>赤ドラですか？</label></li>}
      </ul>
    </div>
    <div className="dialog-footer mt-2 mb-3 grid grid-cols-2 gap-2 ml-3 mr-3">
      ...
      <button type="button" className="button primary-button" onClick={registerPai}>
        登録する
      </button>
    </div>
  </div>
