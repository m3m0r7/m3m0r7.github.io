...
export class ShouSanGen implements Yaku {
  ...
  get isFulfilled(): boolean {
    ...
    const hakuIsFulFilled = (new Haku(this.paiPairCollection, this.option)).isFulfilled
    const hatsuIsFulFilled = (new Hatsu(this.paiPairCollection, this.option)).isFulfilled
    const chunIsFulFilled = (new Chun(this.paiPairCollection, this.option)).isFulfilled
